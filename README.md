# Clients for the Account API (Version 1.0)
  ...
  * System.ComponentModel.Annotations (5.0.0)
  ...
  To initialize your client with your APIKey you can use the following snippet:
    ```
     ...
     KeyManagementApi keyManagementApi = new KeyManagementApi(configuration);
    ```
...
* **Java:** Please add the following dependencies to your project
  ...
  ```       
   ...
   KeyManagementApi keyManagementApi = new KeyManagementApi(apiClient);
   ```
...
* **TypeScript:** Please add the following dependecies to your project
  ...
  * typescript-http-client (0.10.1)
  ...
  To initialize your client with your APIKey you can use the following snippet:
    ...
    let keyManagementApi: KeyManagementApi = new KeyManagementApi(configuration);
    ```

 &nbsp;  
 &nbsp;  
 Please refer to our [Account API](https://developer.myptv.com/en/documentation/quick-start-account-api) documentation.