...
namespace PTV.Developer.Clients.account.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.myptv.com/account/v1";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.myptv.com/account/v1"},
        ...
        public Configuration(
            ...
            string basePath = "https://api.myptv.com/account/v1") : this()
        {
        ...
        {
            string report = "C# SDK (PTV.Developer.Clients.account) Debug Report:\n";
